    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nowPlaying.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent nowPlayingIntent = new Intent(LibraryActivity.this, PlayingActivity.class);
        ...
        recentPlay.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                Intent recentPlayIntent = new Intent(LibraryActivity.this, RecentActivity.class);
